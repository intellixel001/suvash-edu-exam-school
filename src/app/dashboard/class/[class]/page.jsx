  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        link: "/newbies-bcs-200days-full-syllabus",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        link: "/current-affairs-test",
      },
      {
        id: 2,
        title: "বাংলাবিদ (সাহিত্য)",
        link: "/bangla-literature",
      },
      {
        id: 3,
      ...
      },
      {
        ...
        link: "/vocabulary-booster",
      },
      {
        id: 15,
        title: "Bank Math Master",
        link: "/bank-math-master",
      },
      {
        id: 16,
        title: "Bank English Preparation",
        link: "/bank-english-prep",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        link: "/bank-prep-long-course",
        live: true,
      },
      {
        id: 2,
        title: "ব্যাংক নিয়োগ বিষয়ভিত্তিক প্রস্তুতি",
        link: "/bank-prep-subject-wise",
        live: true,
      },
      {
        id: 3,
        title: "ব্যাংক ডেইলি কুইজ",
        link: "/bank-prep-daily-quiz",
      },
      {
        id: 4,
        title: "ব্যাংক মডেল টেস্ট [সাপ্তাহিক]",
        link: "/bank-prep-weekly-model-test",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        link: "/food-directorate-prep",
      },
      {
        id: 7,
        title: "উপসহকারী কৃষি কর্মকর্তা নিয়োগ [Archived]",
        link: "/sub-assistant-agri-archived",
      },
      {
        id: 8,
      ...
      },
      {
        ...
        link: "/petrobangla-combined-archived",
      },
      {
        id: 10,
        title: "পেট্রোবাংলা ফুল মডেল টেস্ট [Archived]",
        link: "/petrobangla-full-model-test-archived",
      },
      {
        id: 11,
        title: "ইউনিয়ন সমাজকর্মী প্রস্তুতি [Archived]",
        link: "/union-social-worker-archived",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        link: "/bar-council-enrollment-2025",
      },
      {
        id: 3,
        title: "বার কাউন্সিল ও বিজেএস জব সল্যুশন",
        link: "/bar-council-bjs",
      },
      {
        id: 4,
        title: "বার কাউন্সিল প্রস্তুতি - লং কোর্স [আর্কাইভড]",
        link: "/bar-council-long-course-archived",
      },
    ],
  },
  {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {section.items.map((item) => (
            <button
              ...
              onClick={() =>
                router.push(
                  "/dashboard/" + "class/" + sectionId + "/subject/" + item.id
                )
              }
